...
<!-- `packagename`, `department`, `department_url`, `institution`, `recon`, `recon_description` are extracted from the DESCRIPTION file -->
...
<!-- About pkg citation in README.md see https://github.com/bluegreen-labs/ecmwfr#how-to-cite-this-package-in-your-article -->
